...
class LoginActivity : OAuthLoginActionBarActivity<TwitterClient>() {
    ...
    override fun onLoginSuccess() {
        ...
        Log.i("sabrina", "Logged in successfully")
        //whenevr we log in we want to be able to load in the tweets, so need new intent that goes to tweets
