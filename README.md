...
Time spent: 10 hours spent in total, 5 on each part
# Part 2
## User Stories
...
<img src='https://i.imgur.com/hJv9cRq.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

I was able to utilize Parcelize, new intents, and using POST requests with this portion of the TwitterClient app! Going back to the main page and updating the tweet was a bit challenging for me as I had a different idea of implementation, but I was able to figure it out! 
